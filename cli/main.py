...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  main.py convert --from <aedb|auroradb|odbpp> --to <aaf|auroradb> <input> -o <out>\n"
            "  main.py inspect source --format <aedb|auroradb|odbpp> <input>\n"
            "  main.py dump source-json --format <aedb|auroradb|odbpp> <input> -o <file>\n"
            "  main.py dump semantic-json --from <aedb|auroradb|odbpp> <input> -o <file>\n"
            "  main.py schema --format <aedb|auroradb|odbpp|semantic>\n"
